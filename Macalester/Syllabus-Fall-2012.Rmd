...
* [Eradication of smallpox](Public/EradicationOfSmallpox.pdf)
...
* [Austin Bradford Hill on association and causation](Public/Hill_1965.pdf) 
...
* [A Primer on the Economics of Health Care](Public/ohe.pdf) 
...
**In-class**:
* [Risk charts](Public/799.pdf) from Woloshin, Schwartz, and Welch
...
* [Truth and Death in Iraq under Sanctions](Public/Iraq-under-sanctions.pdf), (2010) *Significance* 7(3)
...
* [Eradication of Polio](Public/EradicationOfSmallpox.pdf)
* Atul Gawande, [The Cancer Cluster Myth](Public/clustermyth.pdf)
...
**In-class**:
* World Health Organization exercise on [population attributable fraction](Public/Activities/Exercise_27_smoking_and_death.xls) (Finally!)
...
**In-class**:
* Dealing with Confounding: [Moped injury activity](Public/moped-activity.pdf)

* [Necessary and sufficient exercise](Public/Activities/necessary-and-sufficient-exercise.pdf)
...
* [Summary notes on detection theory](Public/detection.pdf)
* [Slides from the class](Public/detection-new.ppt)
...
**In Class**:
* [Ethnic profiling activity](Public/Activities/detection-article.pdf)
...
**In-class**:
* Screening for Mad-Cow disease
* [Slides on Trade-Offs](Public/tradeoffs.pptx)
...
* [Five-Hundred Life-Saving Interventions and their Cost Effectiveness](Public/500-interventions.pdf)
...
**In-class**:
* [Allocating health-care resources](Public/Activities/Health-Care-Choices.pdf)
* [Risk Calculation -- Annuity Value](Public/Activities/Epi-Annuity-Game.pdf)
...
* Atul Gawande, *Better*
    * "The Bell Curve"
    * "For Performance"
* Goldhill, ["How American Health Care Killed My Father"](Public/HowHealthCareKilledMyFather.pdf)
...
* [QALYs on Wikipedia](Public/qaly-method.pdf)

**In-class**:
* [Prioritizing health-care options](Public/Activities/QALY-Methodology.pdf)
...
A [collection of review questions](Public/Epi-Review-Collection-F2011.pdf) and a version with the [multiple choice answers marked](Public/Epi-Review-Collection-F2011-d701251881.pdf).
...
* Don Berwick (see this [news article](http://www.nytimes.com/2011/11/24/health/policy/dr-donald-m-berwick-resigns-as-head-of-medicare-and-medicaid.html?scp=2&sq=donald%20berwick&st=cse))
    * From heroic to managed medicine: [The Epitaph of Profession](Public/bjgp_08_JohnHuntLecture_Berwick_AOP1.pdf)
    * [The Science of Improvement](Public/JAMA-Berwick-1151.pdf)
* [Does preventive care save money?](Public/661.pdf)

**In-class**:
* [QALY Methodology](Public/Activities/QALY-Methodology.pdf)
