...
![Table 5.1](../Public/Figures/EE-Table-5-1.png)  
...
* [WHO spreadsheet here](../Public/Activities/Exercise_27_smoking_and_death.xls)
...
![Table 5.6](../Public/Figures/EE-Table-5-6.png) 

Example: Bicycle helmets and head injury 
![Table 5.9](../Public/Figures/EE-Table-5-9.png)

Why the Odds Ratio Approximates the Relative Risk (when the prevalence/incidence is very small): [Box 5.5](../Public/Figures/EE-Box-5-5.png)
