...
![1.1](../Public/Figures/EE-Table-1-1.png) 
![1.2](../Public/Figures/EE-Table-1-2.png) 
...
![Napoleon's invasion of Russia](../Public/Figures/Napoleon-in-Russia.png)
...
![image](../Public/Figures/EE-Fig-5-1.png)
...
* Go over the calculations using the time-line plot: line-chart.r.
  This is meant to be similar to the [diagram shown in the book:](../Public/Figures/EE4.pdf) Assign each student a case number and ask them to describe the course of their disease.  Then work with the diagrams on the board.

![image](../Public/Figures/EE4.png)
...
### Population pyramids: 
[India](../Public/Figures/MT4-India.pdf)
[USA](../Public/Figures/MT4-USA.pdf)

![image](../Public/Figures/MT4-India.png)
![image](../Public/Figures/MT4-USA.png)
...
* How matters change with age: Examples:
    * All cause death rates: 
        ![image](../Public/Figures/MT1b.png)

* Motor vehicle-related injuries: 
    ![image](../Public/Figures/MT1a.png)
...
* Site-specific cancer rates over the last 70 years
    ![image](../Public/Figures/MT6.png)

* [Comparing hispanic and not hispanic](../Public/Figures/MT5.pdf):
    ![image](../Public/Figures/MT5.png)
...
![image](../Public/Figures/AllCauseMortalityTrends-US.png)
...
* How it's done. 
    [Standard populations:](../Public/Figures/EE7.pdf).
    [The calculation itself:](../Public/Figures/EE8.pdf)

![image](../Public/Figures/EE7.png)

![image](../Public/Figures/EE8.png)
...
[PDF version](../Public/Figures/MT3.pdf)
