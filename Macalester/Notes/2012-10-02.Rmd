...
![EE Figure 12.4 point-source](../Public/Figures/EE-Fig-12-4.png)
* Epidemic curve for a propagative epidemic, in the early phases when the waves are still distinct. 
![EE Figure 12.5](../Public/Figures/EE-Fig-12-5.png)   
* The Danish tuberculosis epidemic.
![EE Figure 12.6](../Public/Figures/EE-Fig-12-6.png) 
* Conversion rate for students in different settings: 
![EE Table 12.2](../Public/Figures/EE-Table-12-2.png)
* Long-term tracking of cases ![EE Table 12.3](../Public/Figures/EE-Table-12-3.png)
...
![EE Figure 12.1](../Public/Figures/EE-Fig-12-1.png)  
...
![from MT p. 47](../Public/Figures/DiseaseSpread/diseases3.png)
* Inanimate sources: 
![inanimate sources](../Public/Figures/DiseaseSpread/inanimate-sources.png)
* Portal of entry and exit: 
![portals](../Public/Figures/DiseaseSpread/portal.png)
* Infectious disease names and classification 
![Friis and Sellers p. 440](../Public/Figures/DiseaseSpread/diseases2.png)
* Bacterial Microbe Sources 
![from MT p. 52](../Public/Figures/DiseaseSpread/microbe-sources.png)  
* Other Microbe Sources 
![from MT p. 52](../Public/Figures/DiseaseSpread/microbe-sources2.png)
*Available vaccines 
![from MT p. 62](../Public/Figures/DiseaseSpread/vaccines-available.png) from MT p. 62

### Spread and Immunization

* Severity 
![severity](../Public/Figures/DiseaseSpread/severity.png)
* Sources of resistance 
![resistance](../Public/Figures/DiseaseSpread/resistance.png)

### Herd Immunity
Diagram of a population, showing a low immunization level which
falls short of protecting individuals within the group.
![From MT p. 64](../Public/Figures/DiseaseSpread/spread-and-immunization1.png) 
and effective immunization 
![effective immunization](../Public/Figures/DiseaseSpread/spread-and-immunization2.png)

*[Levels of Preventive Measures](../Public/Figures/DiseaseSpread/levels-of-preventive-measures.png)
